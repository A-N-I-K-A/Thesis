...
def key_generation_user(Us):
    ...
    for user in user_list:
        ...
        #storing the shares of p in system
        shares=[]
        temp=str(p).encode('UTF-8')
...
def calculate_shares(DU):
    ...
    if padding_yes==1:
        ...
        p= unpadder.update(p) + unpadder.finalize() 
...
def calc(Message,access_policy):
    ...
    p,t6=calculate_shares(DU)
    ok,M,t7=decryption_DU(DU,N1,N2,C,C0,CH,p,Qd,ok)   
    if (ok==True):
        # print("\nMessage",Message)
        # print("\n",M)
...
encrypted_path='/home/anika/Desktop/Thesis/Image_data/Encrypted_40/'
path_to_write='/home/anika/Desktop/Thesis/Image_data/Decrypted_40/'
